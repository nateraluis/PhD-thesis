\chapter{Data-driven strategies for optimal bicycle network growth}\label{ch:BikeGrowth}
...
In the first two chapters we investigated the interconnected network of urban transportation systems. Here, we shift our attention to the bicycle layer. We do this for two reasons: first, to investigate one of the two infrastructure layers dedicated to active-human mobility, however, one of the most underdeveloped layers. Second, due to the lack of research on how to extend bicycle infrastructure comprehensively and systematically.
