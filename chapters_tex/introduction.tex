...
% We know certain things from cities, however we still lack knowledge in:
% How simillar are cities based on their mobility infrastructure
% If we focus on just one layer, how can we improve its connectivity.
% How can we leverage the network approach to measure liveability in a city.
